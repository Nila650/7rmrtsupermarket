...
public class ScreenShotUtility {
	...
	public void getScreenShot(WebDriver driver, String failedTestCase) throws IOException {
		...
		String timeStamp = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss").format(new Date()); // to get current
																							// date/format-to convert to
																							// string
		File f1 = new File(System.getProperty("user.dir") + "//OutputScreenShot"); // directory where to generate
																					// screenshot
		if (!f1.exists()) {
